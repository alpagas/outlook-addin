...
namespace OAGUI.DataControl
{
    ...
    public class SmallComboDataControl : SmallComboDataContainer
    {
        ...
        public override void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SmallComboDataControl));
            ...
            // fieldName
            // 
            this.fieldName.DoubleClick += new System.EventHandler(this.button1_Click);
            // 
            // panel1
            // 
            ...
            // 
            // SmallComboDataControl
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.Name = "SmallComboDataControl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (var comboForm = new CombofieldForm())
            {
                ...
                {
                    var form = ((Form)o);
                    form.Location = new Point(point.X - form.Width+169, point.Y-5);
                };
